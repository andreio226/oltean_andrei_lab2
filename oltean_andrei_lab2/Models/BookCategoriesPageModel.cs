...
namespace oltean_andrei_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(oltean_andrei_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(oltean_andrei_lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
